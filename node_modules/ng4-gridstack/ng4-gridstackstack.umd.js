(function (global, factory) {
	...
	(factory((global['ng4-gridstackstack'] = {}),global._angular_core,global._angular_common));
...
var GridStackItemComponent = (function () {
    ...
    function GridStackItemComponent(el, renderer) {
        ...
        this.onGridConfigurationChanged = new _angular_core.EventEmitter();
...
GridStackItemComponent.propDecorators = {
    'contentPlaceholder': [{ type: _angular_core.ViewChild, args: ["contentPlaceholder", { read: _angular_core.ViewContainerRef },] },],
    'contentTemplate': [{ type: _angular_core.Input },],
    'option': [{ type: _angular_core.Input },],
    'onGridConfigurationChanged': [{ type: _angular_core.Output },],
};
...
GridStackComponent.propDecorators = {
    ...
    'items': [{ type: _angular_core.ContentChildren, args: [GridStackItemComponent,] },],
};
